...
- **行動経済学とゲーム理論は前提が違う。**
  - 行動経済学
    - 相手との差も利得に入れる。
    - 読みの深さには個人差がある。
    - 良い行動ほど選びやすいが、確率的にはブレる。
  - ゲーム理論
    - 自分の金銭的利益だけ考える。
    - 全員が無限に深く読み合う。
    - 常に最適な行動を選ぶ。
- **行動経済学とゲーム理論は前提が違えど、両者は相容れないものではなく、レイヤー（役割）が違う**だけ。
  - ゲーム理論の反対仮説を行動経済学が提供する。
- **行動経済学が価格予測モデルに使用できるのは、「予測」レイヤー**
  - 条件Xが成り立つとき、人は平均してY方向にズレる
  - つまり、**行動経済学は絶対的なものを観察する学問ではなく、差を見る学問**であると言える。
  - 絶対的な価格というよりも、買値からの差を観察するときに利用できる。
- **行動経済学およびゲーム理論はどちらも仮説を生むための道具。**
  - **特徴量を直接にうむ道具では無い**ことに注意。
  - 実務上、仮説から特徴量を考えるときは、ゲーム理論を起点にした仮説よりも、行動経済学を起点にした仮説の方が扱いやすい。
    - なぜなら、行動経済学の材料となるデータの方が収集しやすいから。
    - ゲーム理論の材料となるデータは集めにくい。
- 参照点依存・損失回避・処分効果
  - 人は絶対的な価格では無く、含み益、含み損で行動する（基準からの差で判断する）。 -> この差は人によって違う。なぜなら、人によって買った価格（基準点）が違うから。
- ゲーム理論も行動経済学も、価格予測モデルを構築する上では、仮説をうむ道具である。
  - 価格を直接予想するための材料であるということではない。
  - あくまで仮説を立てることであって、その仮説を検証するプロセスは必須。
#### 疑問点
- 行動経済学とゲーム理論は、そもそもレイヤー（役割）が違うことはわかったが、ゲーム理論は市場に出てくるステークホルダーを捉えることが起点となるという認識で良いか？
それともそもそもステークホルダーを洗い出す部分で使用できる概念であるか？
- ゲーム理論の方が行動経済学よりも、特徴量抽出に関して扱いづらいとのことであったが、これは、ゲーム理論を起点とする仮説を立てる材料となるデータが収集しづらいという認識であっているか？
この弱点を補完する理論や方法は何かないか？
